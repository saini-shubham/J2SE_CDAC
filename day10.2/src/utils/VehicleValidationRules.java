...
public class VehicleValidationRules {
	...
	public static Date startDate; 				//we haven't used final keyworrd here: Reason javac allow intilization of primitive type declare as final somewhere else but if refrence type is declared as final you won't be able to intilize using static intilizer block
