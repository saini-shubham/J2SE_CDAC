...
public class StudentCollectionUtils {
	...
	//sort student details as per DOB
		public static List<Student> sortStudentsByDob(Map<String,Student> students){
			return students.values()		//collections view of map
					.stream()		//stream of students
					.sorted((s1,s2)-> (s1.getDob().compareTo(s2.getDob())))  //stream of students in a sorted manner
					.collect(Collectors.toList());
		}	
		
		//sort students as per GPA
		public static List<Student> sortStudentsByGpa(Map<String,Student> students){
			return students.values()		//collections view of map
					.stream()		//stream of students
					.sorted((s1,s2) -> ((Double)s1.getGpa()).compareTo(s2.getGpa()))   //stream of students in a sorted manner
					.collect(Collectors.toList());
		}	
}
