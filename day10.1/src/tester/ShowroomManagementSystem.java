...
public class ShowroomManagementSystem {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			// can you create the instance of the delivery address without creating the
			// instance of vehicle? -> 100% YES it is possible but buisnnes logic wise
			// is there any sense of having a delivery address without vehicle?
			DeliveryAddress a = new DeliveryAddress(null, null, null, null); // -> currently an example of aggregation
			...
			while (!exit) {
				System.out.println(
						"options: 1) Add new Vehicle 2) Display showroom in info 3) update 4) purchase vehicle 10)exit");
				...
				try {
					...
					case 3:
						...
						// this method return a msg indicating sucess or throw the exception in case of
						// failure
