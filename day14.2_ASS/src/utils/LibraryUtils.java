...
public class LibraryUtils {
	public static HashMap<String,Book> populateList() {
	...
	System.out.println("added"+ map.put("Emech", new Book("Emech", Category.NOVEL, 500, parse("2015-12-12"), "PSBhimra", 1600)));
	System.out.println("added"+ map.put("Rangoli", new Book("Rangoli", Category.POEMS, 500, parse("2020-01-12"), "Rama", 200)));
