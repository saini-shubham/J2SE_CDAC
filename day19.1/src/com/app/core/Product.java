...
public class Product implements Serializable{
	 ...
	 * 
	 */
	//private static final long serialVersionUID = -1217485442123865625L; //reccommended is default serial version id
	private int id;
	private String name;
	private Category productCatgeory;
	private transient LocalDate manufactureDate;  //remove transient keyword and generate the serialversionID & compare both id(with transient & w/o transient)
