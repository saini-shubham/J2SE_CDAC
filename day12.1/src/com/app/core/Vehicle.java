...
public class Vehicle implements Comparable<Vehicle> {
	...
	public int compareTo(Vehicle anotherVehicle) {
		System.out.println("in vheicle's compareTo");
		return this.chasisNo.compareTo(anotherVehicle.chasisNo) ;   //invoking string's class compareTo which is based on lexographically compariosn
